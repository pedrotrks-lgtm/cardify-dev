...
describe('Add Card E2E', () => {
    ...
    cy.fixture('cards').then((data) => {
      ...
      cy.intercept('POST', 'http://wallet.cardfify.dev/api/cards', {
        ...
        body: { ...data.validCard, id: 1 }
         ...
         addCardPage.fillCardForm(data.validCard)

         addCardPage.submit()

         addCardPage.validateSuccessMessage()
  ...
  it('Valida nome com menos de 2 caracteres', () => {
    ...
    addCardPage.fillCardForm(data.invalidName)

    addCardPage.submit()

    addCardPage.validateErrorMessage(
  ...
  it('Valida data de expiração inválida', () => {
    ...
    addCardPage.fillCardForm(data.invalidExpirationDate)
  ...
  it('Valida CVV inválido', () => {
    ...
    addCardPage.fillCardForm(data.invalidCVV)
